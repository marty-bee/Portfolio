...
export default function Titler() {
    ...
    return (
        <>
            <div id='centering' className="flex flex-row justify-center pt-40 pb-36 w-full">
                <div id='titleBox' className="items-center justify-center w-full md:w-3/5" >
                    <h1 className='font-sans sm:text-4xl md:text-8xl font-bold text-left pr-4'>Martyn</h1>
                    <h1 className="font-sans sm:text-4xl md:text-8xl font-bold text-right pl-4
                    bg-pink-400 mt-2">Billings</h1>
                    <div className="font-sans sm:text-xl md:text-4xl text-justify flex justify-between mt-1" aria-label="Full Stack Developer">
