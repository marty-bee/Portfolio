...
export default function BootRant(){
    ...
    return(
        <>
            ...
            <div className="h-96 sm:h-500 overflow-hidden relative box-border rounded-2xl mt-4 mb-4 sm:mt-8 sm:mb-8">
            ...
            {/* refined problem */}
            <div className="h-96 overflow-hidden relative box-border rounded-2xl mt-4 mb-4 sm:mt-8 sm:mb-8">
