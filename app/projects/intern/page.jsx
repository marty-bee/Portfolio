...
// date import
import { internProjObj } from "@/app/projectData/project-page-data-files/internObj-projectPageData"

export default function internProj(){

    return(
        <>
            < ProjectPage projectTitle={internProjObj.projectTitle}
            buttonLinks={internProjObj.buttonLinks}
            techStack={internProjObj.techStack} />
            <br/>
            ...
            <div className="h-32 sm:h-96 md:h-500 overflow-hidden relative box-border rounded-2xl mt-2 mb-2 sm:mt-4 sm:mb-4 max-w-screen-2xl">
                <Image src='/images/intern/internDashboard.png' alt='Intern dashboard' fill={true} className="object-scale-down relatrive"/>
            </div>
            ...
            <p className="text-left">Upon receiving the brief we laid out our assumptions so we could understand the gaps in our knowledge and assert what we needed to verify to ensure we understand the problem so that we could design an appropriate solution. Time was dedicated to studying the Zoom documentation as there are a lot of options and interactions that can be tracked using specific means. We couldn&apos;t begin to ideate if we did not understand the capabilities available to us.</p>
            <br/>
            ...
            {/* engagent algo codes */}
            <div className="h-32 sm:h-96 md:h-500 overflow-hidden relative box-border rounded-2xl mt-1 mb-1 sm:mt-2 sm:mb-2 max-w-screen-2xl">
            ...
            {/* final retro */}
            <div className="h-32 sm:h-96 md:h-[24rem] overflow-hidden relative box-border rounded-2xl mt-2 mb-2 sm:mt-4 sm:mb-4 max-w-screen-2xl">
                <Image src='/images/intern/finalretro.png' alt='Final team retro before christmas' fill={true} className="object-scale-down relatrive"/>
            </div>
            ...
            <ul className="list-disc list-inside pl-2 indent-4">
                ...
                <div className="h-32 sm:h-96 md:h-[26rem] overflow-hidden relative box-border rounded-2xl mt-4 mb-4 sm:mt-4 sm:mb-4 max-w-screen-2xl">
